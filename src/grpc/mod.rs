...
impl SiftChannelBuilder {
    ...
    pub fn new(credentials: SiftChannelConfig) -> Self {
    ...
    pub fn build(self) -> SiftChannel {
        let SiftChannelConfig { uri, apikey } = self.credentials;
        ...
        let channel = Endpoint::from_shared(uri)
            ...
            .expect("failed to initialize endpoint")
            .connect_lazy();
